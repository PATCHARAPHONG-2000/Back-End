...
class Knowledge_news extends StatefulWidget {
  const Knowledge_news({super.key});

  @override
  State<Knowledge_news> createState() => _Knowledge_newsState();
}

class _Knowledge_newsState extends State<Knowledge_news> {
  String? images;
  ...
  Future<void> _uploadFiles() async {
    try {
      ...
      final firabase_storage.Reference refe = firabase_storage
          ...
          .ref()
          .child('Dental_News/PDF/Knowledge_News');
  ...
  saveItem() async {
    ...
    if (imageUrl != null && imageUrl_1 != null) {
      await FirebaseFirestore.instance.collection('Dental_Knowledge_news').add({
